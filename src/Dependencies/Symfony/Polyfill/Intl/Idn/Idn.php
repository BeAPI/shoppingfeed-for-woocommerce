...
namespace ShoppingFeed\ShoppingFeedWC\Dependencies\Symfony\Polyfill\Intl\Idn;

use Exception;
use SF_Dep_SF_Dep_SF_Dep_Normalizer;
use ShoppingFeed\ShoppingFeedWC\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\DisallowedRanges;
use ShoppingFeed\ShoppingFeedWC\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex;
...
final class Idn
{
    ...
    private static function process($domain, array $options, Info $info)
    {
        ...
        if (!SF_Dep_SF_Dep_SF_Dep_Normalizer::isNormalized($domain, SF_Dep_SF_Dep_SF_Dep_Normalizer::FORM_C)) {
            $domain = SF_Dep_SF_Dep_SF_Dep_Normalizer::normalize($domain, SF_Dep_SF_Dep_SF_Dep_Normalizer::FORM_C);
        }
    ...
    private static function validateLabel($label, Info $info, array $options, $canBeEmpty)
    {
        ...
        if (!SF_Dep_SF_Dep_SF_Dep_Normalizer::isNormalized($label, SF_Dep_SF_Dep_SF_Dep_Normalizer::FORM_C)) {
